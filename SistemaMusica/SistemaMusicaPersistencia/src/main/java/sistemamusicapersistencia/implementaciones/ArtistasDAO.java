...
public class ArtistasDAO implements IArtistasDAO {
    ...
    /**
     * Metodo que registra a un nuevo artista Accede a la coleccion "artistas" y
     * mapea en ella los atributos especificados en la clase POJO "Artista" Crea
     * un objeto artista, le da los datos del artistaDTO y persiste al nuevo
     * artista banda
     *
     * @param nuevoArtista
     * @return
    ...
    /**
     * Metodo que busca artistas por su nombre Accede a la coleccion "artistas",
     * crea un nuevo documento para filtrar los resultados con base al campo
     * nombre del artista, Se buscaran los artistas que su nombre coincida con
     * el nombre introducido por el usuario, siendo insensible a mayusculas o
     * minusculas Se guardaran los artistas que coincidieron con el nombre en
     * una lista y se regresara la lista.
     *
     * @param idUsuario
     * @param nombre
    ...
    /**
     * Metodo para buscar un artista en base a un id en la base de datos
     *
     * @param idArtista ID del artista a buscar
     * @return Artista obtenido con el id mencionado
     */
    @Override
    public Artista buscarArtistaPorId(String idArtista) {
        MongoDatabase baseDatos = ManejadorConexiones.obtenerBaseDatos();
        MongoCollection<Artista> coleccion = baseDatos.getCollection(COLECCION, Artista.class);

        Document filtros = new Document();
        filtros.append(CAMPO_ID, new ObjectId(idArtista));
    ...
    /**
     * Metodo para buscar artistas con un genero Accede a la coleccion
     * "artistas", crea un nuevo documento para filtrar los resultados con base
     * al genero del artista Se buscaran los artistas que su genero coincida con
     * el genero introducido y se guardaran en una lista y se regresara.
     *
     * @param idUsuario
     * @param genero
    ...
    /**
     * Metodo que busca artistas por su nombre y por su genero Accede a la
     * coleccion "artistas", crea un nuevo documento para filtrar los resultados
     * con base al genero y al nombre del artista Se buscaran los artistas que
     * tengan el mismo genero que el introducido y el mismo nombre que el
     * introducido siendo insensible a mayusculas o minusculas Se guardaran los
     * resultados en una lista y se regresara.
     *
     * @param idUsuario
     * @param nombre
     * @param genero
    ...
    /**
     * Metodo que busca todos los artistas Accede a la coleccion atristas y
     * regresa todos los artistas
     *
     * @param idUsuario
     * @return lista de artistas
     */
    ...
    /**
     * Metodo que busca un artista por su nombre Accede a la coleccion artistas,
     * crea un filtro para filtrar por nombre, busca si hay artistas con el
     * mismo nombre si hay un artista con el mismo nombre se devuelve al
     * artista, de lo contrario no devuelve nada
     *
     * @param nombre
     * @return
     */
    ...
    /**
     * Crea un nuevo documento integrante dentro del documento artista Crea el
     * documento integrante con los atributos savados del nuevoIntegranteDTO y
     * los inserta en el documento artista que coincida con el idArtista y los
     * añade al espacio "integrantes"
     *
     * @param idArtista
    ...
    /**
     * Metodo que recupera todos los integrantes de un artista con el id del
     * artista 1. Accede a la coleccion "artistas", creando un filtro para
     * buscar el documento que coincida con el id proporcionado 2. Selecciona el
     * campo "integrantes" y excluye el campo "_id" del documento, 3. Ejecuta la
     * consulta con el filtro y la proyeccion y agarra el primer resultado (solo
     * hay uno), 4. Verifica que existe el resultado y que es de tipo
     * "integrantes" 5. Extrae los documentos que contienen los integrantes 6.
     * Agrega los resultados a la lista y la devuelve
     *
     * @param idArtista
    ...
    /**
     * Metodo que recupera todos los integrantes que estan activos de un artista
     * con el id del artista 1. Accede a la coleccion "artistas", creando un
     * filtro para buscar el documento que coincida con el id proporcionado 2.
     * Selecciona el campo "integrantes" y excluye el campo "_id" del documento,
     * 3. Ejecuta la consulta con el filtro y la proyeccion y agarra el primer
     * resultado (solo hay uno), 4. Verifica que existe el resultado y que es de
     * tipo "integrantes" 5. Extrae los documentos que contienen los integrantes
     * y verifica que su estado sea activo, si no tiene estado lo tomara como no
     * activo(false) 6. Agrega los resultados a la lista y la devuelve
     *
     * @param idArtista
     * @return lista de integrantes
     */
